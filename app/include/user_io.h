...
#define PLUG_WIFI_LED_IO_MUX     PERIPHS_IO_MUX_MTDI_U
#define PLUG_WIFI_LED_IO_NUM     12
#define PLUG_WIFI_LED_IO_FUNC    FUNC_GPIO12
...
void smartconfig_done(sc_status status,void *data);
void set_plug_status_from_flash(void);
